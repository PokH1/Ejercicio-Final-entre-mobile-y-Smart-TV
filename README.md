...
En la pantalla de confirmación se puede cambiar esa dirección. Sustituye `192.168.1.100` por la IP local del dispositivo que ejecuta la aplicación de TV. Ambos dispositivos deben estar conectados a la misma red Wi-Fi.
...
2. Revisa el pedido, escribe su nombre y configura la dirección de la TV.
